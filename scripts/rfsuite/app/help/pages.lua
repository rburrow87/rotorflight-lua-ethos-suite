...
data["servos_tool"]["TEXT"] = {
    "Override: [*]  Enable override to allow real time updates of servo center point.", "Center: Adjust the center position of the servo.",
    "Minimum/Maximum: Adjust the end points of the selected servo.", "Scale: Adjust the amount the servo moves for a given input.",
